  ...
  return (
    <div className='flex flex-col items-center gap-7 mt-6 w-full'>
        ...
        <div className='flex flex-col gap-6'>
            <input placeholder='First Name'  className='bg-[#F1F1F1]  text-[#7F7F7F] w-[343px] h-[50px]
             border border-transparent rounded-xl pl-2 outline-none'/>
             <input placeholder='Last Name' className='bg-[#F1F1F1] text-[#7F7F7F] w-[343px] h-[50px]
             border border-transparent rounded-xl pl-2 outline-none'/>
             <input placeholder='Email' className='bg-[#F1F1F1] text-[#7F7F7F] w-[343px] h-[50px]
             border border-transparent rounded-xl pl-2 outline-none'/>
             <input placeholder='Password' className='bg-[#F1F1F1] text-[#7F7F7F] w-[343px] h-[50px]
             border border-transparent rounded-xl pl-2 outline-none'/>
        </div>
        ...
        <div className='flex flex-col items-center w-auto gap-8 '>
            <Link to="/goalPage" className=''>
                ...
                from-[#7B91FF] to-[#95BEFF] text-white'>Create an Account</button>
            </Link>
           ...
           <Link to="/welcomePage">
              <p>Already have an account? <span className='text-blue-500 hover:underline
