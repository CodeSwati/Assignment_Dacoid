...
function Page1() {
  return (
    <div className='flex flex-col mt-6'>
        <Link to="/page2" className='flex justify-end text-[#9FB2FF] underline underline-offset-2'>Skip</Link>
        <div className='flex flex-col gap-4'>
            ...
            <p className='text-lg text-[#787878]'>Don't worry if you have trouble determining your goals,
