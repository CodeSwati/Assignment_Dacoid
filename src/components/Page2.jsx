...
function Page2() {
  return (
    <div className='flex flex-col mt-6'>
        <Link to="/createPage" className='flex justify-end text-[#9FB2FF] underline underline-offset-2'>Skip</Link>
        <div className='flex flex-col gap-4'>
            <img className='w-[17rem] h-[rem] flex self-center'  
            ...
            <p className='text-lg text-[#787878]'>Let's keep burning to achieve your goals, it hurts only temporarily,
