  ...
  return (
    <div className='flex flex-col items-center gap-7 mt-6 w-full'>
        ...
        <div className='flex flex-col gap-6'>
             ...
             <p className='underline underline-offset-2 text-sm'>Forgot your password?</p>
        </div>
        ...
        <div className='flex flex-col items-center w-auto gap-8 mt-24'>
            <Link to="/goalPage" className=''>
                ...
                from-[#7B91FF] to-[#95BEFF] text-white'>Sign In</button>
            </Link>
           ...
           <Link to="/createPage">
              <p>Don't have an account yet? <span className='text-blue-500 hover:underline
